...
<div>
<select value={selectedColor} onChange={(e) => handleColorSelection(e.target.value)}>
...
<div>
<select value={selectedCategory} onChange={(e) => handleCategorySelection(e.target.value)}>
...
<div>
  ...
  />
  <label htmlFor="rating-1"><AiFillStar style={{color:"#eeb441"}}/></label>
  </div>
  <div>
  <input
    type="radio"
    ...
    onChange={(e) => setSelectedRating(Number(e.target.value))}
  />
  <label htmlFor="rating-2"><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/></label>
  </div>
  <div>
  <input
    type="radio"
    ...
    onChange={(e) => setSelectedRating(Number(e.target.value))}
  />
  <label htmlFor="rating-3"><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/></label>
  </div>
  <div>
  <input
    type="radio"
    ...
    onChange={(e) => setSelectedRating(Number(e.target.value))}
  />
  <label htmlFor="rating-4"><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/></label>
  </div>
  <div>
  <input
    type="radio"
    ...
    onChange={(e) => setSelectedRating(Number(e.target.value))}
  />
  <label htmlFor="rating-5"><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/></label>
  </div>
  <div>
  <input
    type="radio"
    ...
    onChange={(e) => setSelectedRating(Number(e.target.value))}
  />
  <label htmlFor="rating-6"><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/><AiFillStar style={{color:"#eeb441"}}/></label>
  </div>
</div>
</div>
</div>
...
setCart(cart.filter((product) => product !== productToRemove));
    ...
    const renderCart = ()=>(<div className="Shop">
        ...
        <div className="total">
             {cart.length !== 0 &&(
                <>
                <div className="totalRows"><h1>Items Price</h1><h1>&euro;{itemsPrice.toFixed(2)}</h1></div>
                <div className="totalRows"><h1>Shipping Price </h1><h1>&euro;{shippingPrice.toFixed(2)}</h1></div>
                <hr></hr>
                <div className="totalRows" id="tr"><h1>Total Price </h1><h1>&euro;{totalPrice.toFixed(2)}</h1></div>
