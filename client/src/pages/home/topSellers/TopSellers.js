...
export const TopSellers = ()=>{
    ...
    <Link to="/shop" onMouseLeave={DisplayNoneHandler1} style={{width: "100%",color:"white",textDecoration:"none", height: "100%",position:"absolute",justifyContent: "center",alignItems: "center",flexDirection: "column", background: "#285c7c",opacity:"0.8",cursor: "pointer", display: display1}} ><FaOpencart style={{fontSize:"8rem"}}/></Link>
  </div>
  <div className='details' data-aos="flip-left" onMouseEnter={DisplayFlexHandler2}>
    ...
    <Link to="/shop" onMouseLeave={DisplayNoneHandler2} style={{width: "100%",color:"white",textDecoration:"none", height: "100%",position:"absolute",justifyContent: "center",alignItems: "center",flexDirection: "column", background: "#285c7c",opacity:"0.8",cursor: "pointer", display: display2}} ><FaOpencart style={{fontSize:"8rem"}}/></Link>
  </div>
  <div className='details' data-aos="flip-left" onMouseEnter={DisplayFlexHandler3}>
    ...
    <Link to="/shop" onMouseLeave={DisplayNoneHandler3} style={{width: "100%",color:"white",textDecoration:"none", height: "100%",position:"absolute",justifyContent: "center",alignItems: "center",flexDirection: "column", background: "#285c7c",opacity:"0.8",cursor: "pointer", display: display3}} ><FaOpencart style={{fontSize:"8rem"}}/></Link>
  </div>
